# 91
This repository contains the models `extract_plate.pt` which you can find [https://drive.google.com/file/d/1AnQbLbE4w9mcUoCK_TBRthUFy6m1oN8p/view?usp=drive_link](here) and `file2.pt which you can find [(https://drive.google.com/file/d/1IQyfaDGW6BhoCUtQdd1-eUgqPOL_hM0g/view?usp=drive_link)](here). 
